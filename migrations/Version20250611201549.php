 ...
 */
final class Version20250611201549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE capture_participant_role (capture_id INT NOT NULL, participant_role_id INT NOT NULL, INDEX IDX_666B848A6B301384 (capture_id), INDEX IDX_666B848A4C0EEDA4 (participant_role_id), PRIMARY KEY(capture_id, participant_role_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE capture_element (id INT AUTO_INCREMENT NOT NULL, respondent_role_id INT DEFAULT NULL, validator_role_id INT DEFAULT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, render_template LONGTEXT DEFAULT NULL, render_title VARCHAR(255) DEFAULT NULL, render_title_level INT DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_33ED8BFF5D9D6CDD (respondent_role_id), INDEX IDX_33ED8BFFB2901176 (validator_role_id), INDEX IDX_33ED8BFF12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE form_capture (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE form_field (id INT AUTO_INCREMENT NOT NULL, form_capture_id INT NOT NULL, type VARCHAR(50) NOT NULL, label VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, options JSON DEFAULT NULL COMMENT '(DC2Type:json)', position INT NOT NULL, INDEX IDX_D8B2E19B62F75F10 (form_capture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE interaction (id INT AUTO_INCREMENT NOT NULL, element_in_id INT DEFAULT NULL, element_out_id INT DEFAULT NULL, flow_id INT DEFAULT NULL, service_in_id INT DEFAULT NULL, service_out_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, data_name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, logic JSON DEFAULT NULL COMMENT '(DC2Type:json)', is_conditional TINYINT(1) NOT NULL, condition_label VARCHAR(255) DEFAULT NULL, INDEX IDX_378DFDA7D4DB0AAA (element_in_id), INDEX IDX_378DFDA78D1851EE (element_out_id), INDEX IDX_378DFDA77EB60D1B (flow_id), INDEX IDX_378DFDA7B98B93D4 (service_in_id), INDEX IDX_378DFDA73AC85D4C (service_out_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE participant_role (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, is_internal TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, quiz_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_B6F7494E853CD175 (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE capture_participant_role ADD CONSTRAINT FK_666B848A6B301384 FOREIGN KEY (capture_id) REFERENCES capture (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE capture_participant_role ADD CONSTRAINT FK_666B848A4C0EEDA4 FOREIGN KEY (participant_role_id) REFERENCES participant_role (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE capture_element ADD CONSTRAINT FK_33ED8BFF5D9D6CDD FOREIGN KEY (respondent_role_id) REFERENCES participant_role (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE capture_element ADD CONSTRAINT FK_33ED8BFFB2901176 FOREIGN KEY (validator_role_id) REFERENCES participant_role (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE capture_element ADD CONSTRAINT FK_33ED8BFF12469DE2 FOREIGN KEY (category_id) REFERENCES category (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE question ADD CONSTRAINT FK_B6F7494E853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz_capture (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE migration_versions (version VARCHAR(191) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_general_ci`, executed_at DATETIME NOT NULL, execution_time INT NOT NULL, PRIMARY KEY(version)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_general_ci` ENGINE = InnoDB COMMENT = '' 
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE capture_participant_role DROP FOREIGN KEY FK_666B848A6B301384
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE capture_participant_role DROP FOREIGN KEY FK_666B848A4C0EEDA4
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE capture_element DROP FOREIGN KEY FK_33ED8BFF12469DE2
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE capture_participant_role
        SQL);
        $this->addSql(<<<'SQL'
