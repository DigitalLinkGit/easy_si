...
use App\Design\Form\DataRequestType;
use App\Design\Form\DataTableType;
use App\Design\Service\DataSourceRegistry;
use App\Design\Service\DataTableFactory;
use App\Design\Service\DataTablePresenter;
...
class DataTableController extends AbstractController
{
    ...
    public function new(
        ...
        return $this->render('design/datatable/new.html.twig', [
    ...
    public function edit(
        ...
        return $this->render('design/datatable/edit.html.twig', [
            'tableForm' => $tableForm->createView(),
            'headers'   => $presented['headers'],
            'matrix'    => $presented['matrix'],
            'interactionId' => $interactionId,
    ...
    public function index(Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('design/datatable/index.html.twig', [
            'dataTable' => $dataTable,
            'interactionId' => $interactionId,
            'dataRole' => $dataRole,
        ]);
