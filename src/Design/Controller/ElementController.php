...
use App\Design\Form\ElementType;
use App\Design\Entity\Service;
use App\Design\Form\ServiceType;
use App\Design\Form\ServiceMinimalType;
use App\Design\Service\UploadHelper;
...
final class ElementController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('design/element/index.html.twig', [
            'elements' => $elements,
        ]);
    }
    ...
    public function new(Request $request, UploadHelper $uploadHelper, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('design/element/new.html.twig', [
            'element' => $element,
            'form' => $form,
    ...
    {
        return $this->render('design/element/show.html.twig', [
            'element' => $element,
        ]);
    }
    ...
    public function edit(Request $request, Element $element, EntityManagerInterface $em, UploadHelper $uploadHelper): Response
    {
        ...
        return $this->render('design/element/edit.html.twig', [
            'element' => $element,
