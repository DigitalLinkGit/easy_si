...
use App\Entity\QuizCapture;
use App\Entity\QuestionInstance;
use App\Entity\Condition;
use App\Entity\Question;
use App\Form\QuizCaptureType;
...
final class QuizCaptureController extends AbstractController
{
    ...
    public function addQuestion(
        ...
        QuizCaptureRepository $quizRepo,
        ...
        return $this->render('quiz/add_question.html.twig', [
            'quiz' => $quiz,
            'questions' => $questions,
    ...
    public function attachQuestionInstance(
        int $quizId,
        Request $request,
        EntityManagerInterface $em,
        QuizCaptureRepository $quizRepo,
        QuestionRepository $questionRepo,
        QuestionInstanceRepository $instanceRepo,
    ...
    public function modal(int $id, QuestionInstanceRepository $repository): Response
    {
        ...
        return $this->render('components/modal/_modal_question.html.twig', [
            'instance' => $instance,
        ]);
    }
