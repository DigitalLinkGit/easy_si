...
class Interaction
{
    ...
    #[ORM\ManyToMany(targetEntity: DataTable::class)]
    private Collection $dataTablesIn;

    #[ORM\ManyToOne(targetEntity: DataTable::class)]
    private ?DataTable $dataTableOut = null;
    ...
    {
        $this->dataTablesIn = new ArrayCollection();
     ...
     */
    public function getDataTablesIn(): Collection
    {
        return $this->dataTablesIn;
    }

    public function addDataTablesIn(DataTable $table): static
    {
        if (!$this->dataTablesIn->contains($table)) {
            $this->dataTablesIn->add($table);
        }

        return $this;
    }

    public function removeDataTablesIn(DataTable $table): static
    {
        $this->dataTablesIn->removeElement($table);
        return $this;
    }


    public function getdataTableOut(): DataTable
    {
        return $this->dataTableOut;
    }

    public function setDataTableOut(?DataTable $dataTableOut): static
    {
        $this->dataTableOut = $dataTableOut;
        return $this;
    }
